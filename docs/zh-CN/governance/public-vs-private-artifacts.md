...
- `.codex/`、`.servbay/`、意外残留在 checkout 内的 `.chatcockpit/`、兼容期历史 `.tokenpilot/`、`docs/superpowers/` 等本机/Agent 状态不进入公开 Git；Source/Developer Mode 的 canonical 状态位于仓库外的 `~/.chatcockpit/`。
