...
export const zhCNContinuityCopy: ContinuityCopy = {
  shellTitle: "工作中心",
  shellDescription: "围绕当前执行工作区协调规格与计划、任务、会话、交接、证据、审批与恢复。",
  refresh: "刷新工作状态",
  loadingTitle: "正在加载工作数据",
  loadingDescription: "正在读取已配置项目与执行工作区状态。",
  requestFailedTitle: "工作数据加载失败",
  ...
  sections: {
    projects: {
      label: "项目",
      title: "项目与执行工作区",
      description: "读取真实的项目、仓库关联与执行工作区状态。"
    },
    documents: {
      label: "Specs & Plans",
      title: "规格与执行计划",
  ...
  projectCockpitDescription: "直接读取该项目的权威开发协调状态，不依赖兼容的连续性快照才能显示。",
  projectWorkspaceCard: "项目与执行工作区",
  ...
  projectDetailLoadingDescription: "正在读取该项目的权威执行工作区、Codex 与 MCP 协调状态。",
  ...
  clearBinding: "不绑定",
  saveBinding: "保存绑定",
  noDocumentsTitle: "当前执行工作区没有 Spec / Plan",
  noDocumentsDescription: "创建第一个开发文档后，可版本化、审批并绑定到任务。",
  noDocumentSelected: "选择一个文档以查看当前内容与版本历史。",
  activeSession: "活跃会话",
  parentTask: "父任务",
  noTasksTitle: "当前执行工作区没有任务",
  noTasksDescription: "创建并绑定到该执行工作区的任务会显示在这里。",
  noSessionsTitle: "当前执行工作区没有开发会话",
  ...
  assessThread: "检查原生会话",
  assessmentReady: "已找到与当前执行工作区匹配的原生 Codex Thread。",
  assessmentExpires: "本次验证有效至",
  threadSource: "来源",
  threadProvider: "Provider",
  threadStatus: "状态",
  threadWorkspace: "目标执行工作区",
  ...
  approvalKind: "审批类型",
  approvalStatus: "审批状态",
  refreshSnapshot: "刷新执行工作区状态",
  selectWorkspaceHint: "选择一个执行工作区以读取真实工作状态。",
...
export const enUSContinuityCopy: ContinuityCopy = {
  shellTitle: "Work Center",
  shellDescription: "Coordinate specs and plans, tasks, sessions, handoffs, evidence, approvals, and recovery around the current execution workspace.",
  refresh: "Refresh work state",
  loadingTitle: "Loading work data",
  loadingDescription: "Reading configured projects and execution-workspace status.",
  requestFailedTitle: "Work data request failed",
  ...
  sections: {
    projects: {
      label: "Projects",
      title: "Projects and execution workspaces",
      description: "Read real project, repository association, and execution-workspace status data."
    },
    documents: {
      label: "Specs & Plans",
  ...
  workspaceCount: "Execution workspaces",
  readyWorkspaceCount: "Ready execution workspaces",
  ...
  defaultWorkspace: "Default execution workspace",
  workspaces: "Execution workspaces",
  branch: "Branch",
  headCommit: "HEAD",
  revision: "Revision",
  dirty: "Uncommitted changes",
  clean: "Execution workspace clean",
  statusActive: "Active",
  statusReady: "Ready",
  ...
  projectCockpitTitle: "Project Cockpit",
  projectCockpitDescription: "Read authoritative project development coordination directly without waiting on the compatibility continuity snapshot.",
  projectWorkspaceCard: "Project and execution workspace",
  ...
  workspaceMode: "Execution workspace mode",
  workspaceNativeCheckout: "Native checkout",
  workspaceWorktree: "Explicit worktree",
  workspaceState: "Execution workspace state",
  ...
  codexActionRepair: "Repair the execution workspace first",
  ...
  projectDetailLoadingDescription: "Reading authoritative execution-workspace, Codex, and MCP coordination for this project.",
  ...
  noDocumentsTitle: "No Specs or Plans in this execution workspace",
  ...
  noTasksTitle: "No tasks in this execution workspace",
  noTasksDescription: "Tasks created and bound to this execution workspace will appear here.",
  noSessionsTitle: "No development sessions in this execution workspace",
  ...
  assessmentReady: "The provider-native Codex Thread matches this execution workspace.",
  assessmentExpires: "Assessment expires",
  threadSource: "Source",
  threadProvider: "Provider",
  threadStatus: "Status",
  threadWorkspace: "Target execution workspace",
  ...
  refreshSnapshot: "Refresh execution-workspace state",
  selectWorkspaceHint: "Select an execution workspace to read real work state.",
