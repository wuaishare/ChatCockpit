...
const zhCN: ResourceCenterCopy = {
  ...
  protectedDescription: "当前接口受保护。请先在顶部设置 CHATCOCKPIT_API_TOKEN，再读取 Runtime 与资源状态。",
  ...
  inventoryEmptyDescription: "选择 Runtime Profile 后点击“刷新资源清单”，ChatCockpit 才会通过已审查 Adapter 读取真实状态并追加一份 snapshot。",
...
const enUS: ResourceCenterCopy = {
  ...
  protectedDescription: "This API is protected. Set CHATCOCKPIT_API_TOKEN in the header before reading Runtime and resource state.",
