...
const zhCN: ResourceCenterCopy = {
  ...
  activityTitle: "运行活动",
  activityDescription: "实时观察当前设备上正在执行、等待批准或排队的 Agent Session 与独立作业；Project / 执行工作区不是 Host 级作业的前置条件。",
  activityLive: "实时",
  ...
  activityTerminateConfirmTitle: "终止这个作业进程？",
  activityTerminateConfirmDescription: "这会停止当前受管作业进程。该操作不会终止其他 Activity，也不会撤销 OAuth 授权。",
  ...
  activityPaused: "已暂停",
  activityTotal: "全部",
  activityNoActiveTitle: "当前没有活跃工作",
  activityNoActiveDescription: "新的 Agent Session 或 Host 作业开始后会自动出现在这里，无需手动刷新。",
  activityRecentTitle: "最近活动",
  activityRecentDescription: "仅保留最近完成、失败或终止的条目，避免历史工作淹没当前运行态。",
  activityKindAgent: "Agent Session",
  activityKindJob: "独立作业",
  activityKindDeviceOperation: "设备运行栈操作",
  activityScopeWorkspace: "执行工作区",
  ...
  capabilities: "能力",
  workspace: "执行工作区",
  workspaceRequired: "Codex 资源发现需要明确的执行工作区。",
  workspaceUnavailable: "当前没有可用执行工作区，请先在“项目”中授权或修复执行工作区。",
...
const enUS: ResourceCenterCopy = {
  ...
  activityDescription: "Observe Agent Sessions and standalone work that are running, waiting for approval, or queued on this device. Project and Execution Workspace context is optional for host-scoped work.",
  activityLive: "Live",
  ...
  activityTerminateConfirmTitle: "Terminate this job process?",
  activityTerminateConfirmDescription: "This stops the current managed job process. Other activities and OAuth authorizations are not affected.",
  ...
  activityScopeWorkspace: "Execution Workspace",
  activityScopeRepo: "Repository",
  activityScopeHost: "Host",
  activityRuntime: "Runtime",
  activityJob: "Job",
  ...
  workspaceRequired: "Codex resource discovery requires an explicit Execution Workspace.",
  workspaceUnavailable: "No Execution Workspace is currently available. Authorize or repair one in Projects first.",
  ...
  notApplicable: "N/A",
  userScope: "User",
  workspaceScope: "Execution Workspace",
  runtimeScope: "Runtime",
  registryScope: "Registry",
