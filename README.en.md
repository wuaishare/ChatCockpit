...
Maintainer-only competitive research, commercial strategy, future provider sequencing, and implementation roadmaps are intentionally not part of the public product contract. The public repository documents current product truth and contributor-facing invariants.
