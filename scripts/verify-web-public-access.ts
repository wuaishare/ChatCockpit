...
assert.doesNotMatch(view, /onCutoverCandidate|cutoverCandidate/);
...
assert.match(copy, /显式 cutover 仍是后续独立阶段/);
...
assert.match(copy, /explicit cutover remains a separate later stage/);
